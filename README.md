...
1. IR sensors continuously detect the position of the line.
2. Sensor readings are converted into a positional error.
3. A PID controller computes the required correction.
4. Motor speeds are adjusted independently through the L298N motor driver.
5. The process repeats in real time, allowing the robot to follow the track smoothly.
